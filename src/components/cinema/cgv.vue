...
<style>
  ...
  .sect-smuse li > a,
  .sect-cinfo .share a,
  .sect-cinfo .logo {overflow:hidden; background-image:url(../../assets/cgv/common_sprite_area_v4_2016.png); background-repeat:no-repeat; text-indent:100%; white-space:nowrap;}
  .lnb h2,
  .sect-smuse h2,
  ...
  #cgvwrap #header {background:#fdfcf0 url(../../assets/cgv/bg_header.gif) repeat-x 0 0;} /* 20140620 DanielKim Del height:255px; padding-top:80px; background-position:0 80px; */
  ...
  .sect-service > .gnb li {background:url(../../assets/cgv/bg_v_line.gif) no-repeat 0 50%;}
  ...
  .im-wrap .lnb .sub-wrap {display:none; position:absolute; top:31px; z-index:100; width:164px; padding:3px; background:url(../../assets/cgv/bg_smenu.png) repeat-y 0 0;}
  ...
  .im-wrap .lnb .sub-wrap > i {display:block; position:absolute; top:-10px; left:50%; width:19px; height:10px; margin-left:-9px; background:url(../../assets/cgv/ico_smenu_arrow.png) no-repeat 0 0;}
  ...
  .im-wrap .lnb .sub-wrap > .smenu li.on > a {background:url(../../assets/cgv/ico_smenu_hand.png) no-repeat 100% 1px; color:#e71a0f;}
  ...
  .sect-srh > fieldset button {position:absolute; top:0; right:0; width:31px; height:24px; background-color:#e71a0f; background-image:none; color:#fff; font-weight:500; font-size:11px; line-height:24px; text-align:center;}
  *+html .sect-srh > fieldset button {top:8px;}
  ...
  /* 개인화 영역 */
  .sect-person {width:980px; height:80px; margin:8px auto 9px; padding:9px 0 15px; background:url(../../assets/cgv/bg_com_line.png) repeat-x 0 100%; clear:both}
  .sect-person > ul > li {display:inline-block; float:left; position:relative; border-left:1px solid #231d1d}
  ...
  .sect-person > ul > li > a.arthouse {background-position:-510px -197px;background-image:url(../../assets/cgv/common_sprite_area_v2.png)}
  .sect-person > ul > li > a.phototicket {background-position:-587px -88px;background-image:url(../../assets/cgv/common_sprite_area_v3.png)}

  /* ===========================================
     Contents Area
  ============================================ */
  #contaniner {width:100%;}
  #contaniner.bg-bricks {background:url(../../assets/cgv/bg_c_bricks.png) repeat-x 0 29px}
  #contaniner.bg-bricks.main {background-position:0 0;}
  ...
  .linemap-wrap .sect-linemap > .sect-bcrumb ul > li {margin-left:12px; padding-left:20px; background:url(../../assets/cgv/ico_arrow.png) no-repeat 0 50%; font-size:12px;}
  ...
  *+html .linemap-wrap .sect-linemap > .sect-bcrumb img {margin-top:-4px;}
  ...
  .linemap-wrap .sect-linemap > .sect-special ul li a.specialclub {
    background: url(../../assets/cgv/ico_club_service.png) no-repeat 100% 50%;
    padding-right:25px;
    text-align: left;
  ...
  .linemap-wrap .sect-linemap > .sect-special ul > li a.photi {
    background: url(../../assets/cgv/ico_photi.png) no-repeat 100% 50%;
    padding-right:25px;
  }
  ...
  /* ===========================================
     Footer Area
  ============================================ */
  #footer {background:url(../../assets/cgv/bg_footer_com.gif) repeat-x 0 100%;} /* .sect-ad height 값에 따라 background-position 값 변경 */
  ...
  .sect-smuse li, .sect-cinfo li {display:inline-block; float:left;}
  .sect-smuse li {margin-left:22px;}
  ...
  .sect-cinfo .policy li {background:url(../../assets/cgv/bg_li_vline2.gif) no-repeat 0 1px;}
  .sect-cinfo .policy li:first-child {background-image:none;}
  /* .sect-cinfo .policy li:first-child > a:first-child {padding-left:0;} */
  .sect-cinfo .policy li > a {padding:0 9px; font-weight:500; font-size:13px; color:#444444; text-decoration:none; vertical-align:middle;letter-spacing:-1px}
  ...
  .sect-cinfo .address p {margin-top:8px; height:12px;}
  ...
  .mobile-foot-wrap a {
    ...
    height:54px;
    padding-right:50px;
    background:url(../../assets/cgv/ico_mobile_arrow.gif) no-repeat 100% 50%;
    color:#333;
    font-weight:500;
    font-size:50px;
  }
  ...
  .sect-common {height:450px;}
  .sect-common:before,
  .sect-common:after {position:absolute; top:0; z-index:10; content:''; width:14px; height:450px;}
  .sect-common:before {left:0; background:url(../../assets/cgv/bg_bricks_before.png) no-repeat 0 0;}
  .sect-common:after {right:0; background:url(../../assets/cgv/bg_bricks_after.png) no-repeat 0 0;}
  ...
  *+html .layer-contents .slider .item{ background:none;}
  ...
  .wrap-audio > .audio-contents > p{ height:175px; background:url('../../assets/cgv/bg_txt_sound.gif') 50% 50% no-repeat; font:0/0 a; zoom:1;}
  ...
  .now-showing {bottom:0; z-index:20; width:733px; height:78px; background:url(../../assets/cgv/bg_now_showing.png) no-repeat 0 0;}
  ...
  .now-showing dl dt > a, .now-showing a.link-reservation {background-image:url(../../assets/cgv/sprite_btn.png); background-repeat:no-repeat;}
  ...
  /* Heading Css (only) */
  h3 {height:41px; margin:30px 0 15px; background:url(../../assets/cgv/bg_h3_line.jpg) repeat-x 0 50%; line-height:41px; text-align:center; font-weight:500;}
  h3 > img { padding:0 8px; background-color:#fdfcf0;}
  ...
  /* Heading Css (combo) */
  .tit-heading-wrap {position:relative; height:51px; margin-top:30px; border-bottom:3px solid #241d1e;}
  ...
  *+html .tit-heading-wrap > h3 { display:inline;}
  ...
  .tit-heading-wrap > .submenu {position:absolute; top:18px; right:0;}
  ...
  .tit-heading-wrap > .submenu > ul > li > a:focus {background:url(../../assets/cgv/ico_arrow07.png) no-repeat 0 3px; color:#e40000;}
  ...
  .cols-banner .col-hd .tit-hd {position:absolute; width:486px; height:92px; padding-top:12px; background:url(../../assets/cgv/bg_hdtrailor_bar.png) no-repeat 0 0; text-align:center;}
  .cols-banner .col-hd button[type='button'] {overflow:hidden; position:absolute; width:66px; height:66px; top:50%; left:50%; margin:-33px 0 0 -33px; background:url(../../assets/cgv/sprite_icon.png) no-repeat -121px -21px; text-indent:100%; white-space:nowrap;}
  ...
  .sect-notice-info h3 {height:35px; margin:0 15px 0 0; padding:0 0 0 26px; background:url(../../assets/cgv/ico_notice.png) no-repeat  1px 50%; color:#333; font-size:15px; line-height:35px;}
  ...
  .sect-aside-banner .aside-content-top {padding-top:10px; background:url(../../assets/cgv/bg_aside_banner_top.png) no-repeat 0 0;}
  .sect-aside-banner .aside-content-btm {padding:0 7px 10px; background:url(../../assets/cgv/bg_aside_banner_bottom.png) no-repeat 0 100%;}
  .sect-aside-banner > .btn-top > a {width:116px; height:72px; background:url(../../assets/cgv/btn_top.png) no-repeat 0 0;}
  ...
  *+html .sect-movie-type> ul{ zoom:1;}
  ...
  .sect-movie-type > ul > li:hover, .sect-movie-type > ul > li.on{ background:url('../../assets/cgv/bg_movielist.png') 0 0 no-repeat;}
  ...
  .sect-city li.on > a, .sect-city li > a:focus {color:#333; background:url(../../assets/cgv/ico_arrow02.png) no-repeat 50% 100%;}
  ...
  *+html .showtimes-wrap .slider li.on > .day > a {cursor:pointer;}
  ...
  .cols-mycgv-booking .lst-item .box-contents .screentype a {width:82px; height:17px; background:url(../../assets/cgv/sprite_screentype02.png) no-repeat 0 0; font:0/0 a; vertical-align:middle;}
  .cols-mycgv-booking .lst-item .box-contents .screentype span {width:82px; height:17px; background:url(../../assets/cgv/sprite_screentype02.png) no-repeat 0 0; font:0/0 a; vertical-align:middle; zoom:1;}
  ...
  .sect-showtimes .info-timetable > ul > li .minimap .mini_header span{position:absolute;top:12px;right:7px;width:7px;height:4px;background:url(../../assets/cgv/tabmenu_arrow_white.png) no-repeat;}
  .sect-showtimes .info-timetable > ul > li .minimap.opened .mini_header span{top:11px;background-image:url(../../assets/cgv/tabmenu_arrow_white2.png);}
  .sect-showtimes .info-timetable > ul > li .minimap .mini_container{margin:5px;margin-top:0;position:relative;}
  .sect-showtimes .info-timetable > ul > li .minimap .mini_container .mini_screen{position:absolute;top:0;width:100%;height:15px;line-height:15px;font-size:10px;text-align:center;background:url(../../assets/cgv/screen_bg.png) repeat-x left;}
  ...
  .sect-showtimes .info-timetable > ul > li .minimap .mini_exit{display:none;position:absolute;width:8px;height:8px;background:url(../../assets/cgv/seat_icons.png) no-repeat;background-position:-100px -50px;}
  ...
  .theater_minimap {position:absolute;background:#fcfbf0;border:3px solid #000;z-index:4000}
  .theater_minimap span.arr {position:absolute;left:50%;margin-left:-7px;bottom:-13px;width:15px;height:13px;background:url(../../assets/cgv/bg_arrow04.png) no-repeat 0 0}
  ...
  /* 극장별 상영시간표 */
  .favorite-wrap {position:relative;width:874px;height: 400px;padding: 60px 53px 0;background:url(../../assets/cgv/bg_showtimes_favorite.gif) no-repeat 0 0;}
  ...
  .favorite-wrap .sect-favorite > button[type='button'] {overflow:hidden; position:absolute; top:0; left:794px; width:49px; height:49px; background:#636162 url('../../assets/cgv/btn_plus.gif') 0 0 no-repeat ; border:2px solid #6e6c6d; line-height:49px; text-indent:100%; white-space:nowrap; text-align:center;}
  .favorite-wrap .sect-favorite > button[type='button'].setting {background:#636162 url(../../assets/cgv/icon_setting02.png) no-repeat 50% 50%}
  ...
  .favorite-wrap .sect-city > ul > li * li {margin:6px 35px 0 0;}
  ...
  .favorite-wrap .col-movie-lst li.on > a {background:url(../../assets/cgv/sprite_bar_on.png) no-repeat 0 0;}
  ...
  .favorite-wrap .box-movie-type {position:relative; width:299px; height:247px; padding:10px 0 30px 34px; background:url(../../assets/cgv/bg_box_movie.png) no-repeat 0 0;}
  ...
  .favorite-wrap .box-movie-type li.on > a {background:url(../../assets/cgv/sprite_bar_on.png) no-repeat 0 -40px; color:#fff;}
  ...
  .table-dotline th, .table-dotline td{ padding:15px 0; background:url('../../assets/cgv/dot_horizontal.gif') 0 0 repeat-x; color:#333333; }
  ...
  /* 404 에러페이지 */
  .sect-error,
  .sect-use-stop {width:980px; height:280px; padding-top:150px; text-align:center;}
  .sect-error > h3,
  ...
  .sect-error > h3 {background:url('../../assets/cgv/ico_info.png') 50% 0 no-repeat;}
  .sect-use-stop > h3 {background:url('../../assets/cgv/ico_caution.gif') 50% 0 no-repeat;}
  .sect-error > p,
  ...
  /* 메인 공지사항 */
  .skipnaiv+.layer-wrap {position:absolute; top:20px; left:60px!important; width:280px; height:437px; background:white; z-index:500; }
  .skipnaiv+.layer-wrap .layer-contents {width:280px; height:430px; }
  .noti-main {position:relative; height:380px; margin-top:23px; border-top:1px solid #d5d4ca; /* border-bottom:  1px solid #d5d4ca; */ }
  .noti-main .slider {overflow:visible; }
  .noti-main button[type=button].btn-pause, .noti-main button[type=button].btn-play {left: 5px!important; top:  -19px!important; }
  .layer-contents .noti-main .slider>button[type=button].btn-next, .layer-contents .noti-main .slider>button[type=button].btn-prev {top:  -23px; left: auto; width:  24px; height:  21px; margin: 0; background:  url(http://img.cgv.co.kr/common/images/main/btn_arrow_l.png) 0 0 no-repeat; }
  .layer-contents .noti-main .slider>button[type=button].btn-prev {right:  25px; border-right:  1px solid #ebebec; }
  .layer-contents .noti-main .slider>button[type=button].btn-next {right:  1px; background-image:  url(../../assets/cgv/btn_arrow_r.png); }
  .noti-main .slider .noti-num {position: absolute; top:  -20px; right:  51px; width: 40px; color: #666; font-family: Verdana, Geneva, sans-serif; font-weight: 700; text-align: center; letter-spacing: 2px; }
  .noti-main .slider .noti-num strong {color: #e71a0f; font-family: Verdana, Geneva, sans-serif; font-weight: 700; }
  .noti-main .slider .item {background: #fff; text-align: left; }
  .layer-contents .noti-main .slider .item:before {content: normal; }
  .noti-footer {height: 34px; background: #353535; font-weight:500; line-height:  34px; }
  ...
  .noti-footer .btn-close {right:0; top: auto;width: auto;padding:0 18px; color:#999; font-size:12px; font-weight:500; line-height:34px; background:none; height:34px; border-left:1px solid #484848;}
  .noti-footer .btn-close:before  {content: '창'; }

  .wrap-noti-main..wrap-noti-main {}
  ...
  .layer-wrap.review_pop span.thumb-image {display: inline-block;float: left;}
  ...
  .review_pop_btn {position:absolute; background-image:url(../../assets/cgv/sprite_btn.png); background-repeat:no-repeat; font:0/0 a; zoom:1;overflow:hidden; top:50%; width:26px; height:52px; text-indent:100%; white-space:nowrap; margin-top:-26px;}
  ...
  .cancel_tooltip.cardandphone a.ico_cancel_i:hover .tooltip_con {display: block;width: 293px;height: 217px;background:url(../../assets/cgv/cancel_tooltip_cardandphone.png) no-repeat 0 0;left: -27px;top: -217px}

  .cancel_tooltip.card a.ico_cancel_i:hover .tooltip_con {display: block;width:293px;height:160px;background:url(../../assets/cgv/cancel_tooltip_card.png) no-repeat 0 0;left: -27px;top: -157px;}
  .cancel_tooltip.phone a.ico_cancel_i:hover .tooltip_con {display: block;width:293px;height:143px;background:url(../../assets/cgv/cancel_tooltip_phone.png) no-repeat 0 0;left: -27px;top: -143px;}
  .cancel_tooltip.banking a.ico_cancel_i:hover .tooltip_con {display: block;width:293px;height:281px;background:url(../../assets/cgv/cancel_tooltip_banking.png) no-repeat 0 0;left: -27px;top: -281px;}
  /*로그인 세션 만료*/
  ...
  .layer-wrap.pop_corp_session h1{height: 50px;line-height: 50px;padding-left: 19px;border: 1px solid #707070;color: #f2f0e5;font-weight:300;font-size: 22px;}
  .layer-wrap.pop_corp_session .pop-contents{margin-top: 5px;padding:70px 40px 30px;background-color: #f6f6f4;color: #333;}
  .col_red {color:#e71a0f;}
  .layer-wrap.pop_corp_session .ss_con_wrap {background: url(../../assets/cgv/ico_warning_session.png) no-repeat 33px 0;width: 274px;padding: 10px 0 60px 153px;}
  ...
  .btn-close, .layer-wrap .popwrap button[type='button'].btn-close{display: block;position: absolute;top: 20px;left: auto;right: 20px;width: 18px;height: 18px;background: url(../../assets/cgv/sprite_btn.png) no-repeat -72px -62px;border: none;font-size: 0; line-height:0;zoom: 1;}
  ...
  *+html .list-grade .point em{vertical-align:-8px;}
  ...
  .schedule-util .viewgrade {margin-left:25px; height:13px; line-height:13px; padding-left:18px; background:url(../../assets/cgv/sprite_icon.png) no-repeat 0 -158px; color:#333333; font-weight:500;}
  ...
  .sort-cont1 .slider > button[type='button'] {position:absolute; top:22px; width:16px; height:28px; margin:0; font:0/0 a; background:url('../../assets/cgv/sprite_btn.png') no-repeat -30px -250px;}
  ...
  .sort-cont1 .slider li.on > .day {background:#fff url(../../assets/cgv/sprite_btn.png) no-repeat -61px -97px;}
  ...
  *+html .sort-cont1 .slider li.on > .day > a {cursor:pointer;}
  ...
  .sort-curator > ul > li .thumb {display:inline-block; width:50px; height:50px; background:url('../../assets/cgv/img_curator_thumb.png') no-repeat 0 -256px; vertical-align:middle;}
  .sort-curator > ul > li .thumb2 {display:inline-block; width:50px; height:50px; background:url('../../assets/cgv/img_curator_thumb2.png') no-repeat 0 -256px; vertical-align:middle;}
  ...
  .monthschedule-list .who-is .thumb {display:inline-block; width:70px; height:70px; margin:0 20px 0 45px; background:url('../../assets/cgv/img_curator_thumb.png') no-repeat 0 0; vertical-align:middle;}
  .monthschedule-list .who-is .thumb2 {display:inline-block; width:70px; height:70px; margin:0 20px 0 45px; background:url('../../assets/cgv/img_curator_thumb2.png') no-repeat 0 0; vertical-align:middle;}
  ...
  /*.monthschedule-list .btn_booking {display:inline-block; padding:0 12px; height:25px; line-height:25px; font-size:13px; color:#fff; -webkit-border-radius:3px; -moz-border-radius:3px; border-radius:3px; behavior:url(../../assets/cgv/PIE.htc); background:#000; }*/
  ...
  .ico-grade {
    ...
    width: 21px;
    height: 21px;
    background: url(../../assets/cgv/sprite_icon.png) no-repeat;
    font: 0/0 a;
    zoom: 1;
  }
